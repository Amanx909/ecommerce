            ...
            <div class="offcanvas__content">
               <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                  <div class="offcanvas__logo logo">
                     <a href="index.html">
                        <img src="assets_front/img/footer/footer-pay.png" alt="logo">
                     </a>
                  </div>
               </div>
             ...
             <div class="cartmini__top-wrapper">
                 <div class="cartmini__top p-relative">
                     ...
                     <div class="cartmini__close">
                         ...
                         <a  class=""><i class="fal fa-times"></i></a>
                        </div>
                 </div>
                  ...
                  <div class="row align-items-center">
                     <div class="col-md-6">
                        <div class="tp-header-welcome d-flex align-items-center">
                           ...
                           <p>FREE Express Shipping On Orders </p>
                        </div>
                     </div>
                     <div class="col-md-6">
            ...
            <div class="row align-items-center">
                <div class="col-xl-3 col-lg-3">
                    <div class="tp-header-category tp-category-menu tp-header-category-toggle">
                        ...
                        <?php if(isset($getcategorynav) && !empty($getcategorynav)): ?>
                            <ul>
                                    ...
                                    <?php if($check_sub): ?>
                                        <li class="has-dropdown">
                                            <a href="category/<?=$val->slug?>" class="has-mega-menu">
                                                <img src="uploads/<?=$val->image?>" alt="Category Image" style="width: 20px; height: 20px;">
                                                <?=$val->cate_name?>
                                            </a>
                                            <ul class="mega-menu tp-submenu">
                                                <li>
                                                    <ul>
                                                        <?php $subcategory = $this->HomeModel->getsubcategory($val->cate_id); ?>
                                                        <?php foreach($subcategory as $subcat): ?>
                                                            <li>
                                                                <a href="category/<?=$val->slug?>/<?=$subcat->slug?>"><?=$subcat->cate_name?></a>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </li>
                        ...
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-header-contact d-flex align-items-center justify-content-end">
                              ...
                              <div class="tp-header-contact-content">
                                 <h5>Hotline:</h5>
                                 <p><a href="tel:402-763-282-46">+(977) 9845633928</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
