                                       ...
                                       <div class="col-md-6">
                                          <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                             ...
                                             <div class="profile__main-content">
                                                <h4 class="profile__main-title"><?php echo $user['username']; ?></h4>
                           ...
                           <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                              <div class="profile__info">
                                 ...
                                 <div class="profile__info-content">
                                    <form action="<?php echo site_url('profile/updateProfile'); ?>" method="post">
                                       <div class="row">
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" name= "username" placeholder="Enter your username" value="<?php echo $user['username']; ?>" required>
                                                   <span>
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="email" name="email" placeholder="Enter your email" value="<?php echo $user['email']; ?>" required>
                                                   <span>
                                          ...
                                          <div class="col-xxl-12">
                                             <div class="profile__btn">
                                                <button type="submit"name="updateUserDetails" class="tp-btn">Update Profile</button>
                                             </div>
                                          </div>
                                       </div>
                                    </form>
