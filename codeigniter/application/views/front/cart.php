        ...
        <section class="tp-cart-area pb-120">
            <div class="container">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- price -->
                                            <td class="tp-cart-price"><span>Npr <?=number_format($arr->pro_price)?></span></td>
                                            <!-- quantity -->
                                            ...
                                            <td class="tp-cart-action">
                                                <a href= "cart/removeproduct/<?=$arr->pro_id?>" class="tp-cart-action-btn">
                                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="tp-cart-checkout-wrapper">
                            <div class="tp-cart-checkout-top d-flex align-items-center justify-content-between">
                                ...
                                <span class="tp-cart-checkout-top-price">Npr <?=number_format($total['subtotal'])?></span>
                            </div>
               ...
               <?php else: ?>
                <div class="row">
                <div class="col-md-6"> 
                <h4>No product in Cart <a href= "" class="btn btn-outline-primary">Shop Now</a></h4>
                </div>
                </div>
                       <td class="tp-cart-img" colspan="3"></td>
