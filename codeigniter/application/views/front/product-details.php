                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           <div class="tp-product-details-category">
                              <span><?=$this->HomeModel->categoryname($arr->category)?></span>
                           </div>
                           ...
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price">Npr  <?=number_format($arr->mrp,2)?></span>
                              <span class="tp-product-details-price new-price">Npr <?=number_format($arr->selling_price,2)?></span>
                           </div>
